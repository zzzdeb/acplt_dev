...
// *   History
// *   -------
// *   2018-05-18   File created by Zolboo Erdenebayar
// *
// *******************************************************************************
// *
// *   bfs
...
//	Data_t* data = Ov_HeapMalloc(sizeof(Data_t));
//	data->self = NULL;
//	data->type = ROLLER;
//	data->pparent = NULL;
...
//}
//
//void destructData(Data_t* pdata){
//	Ov_HeapFree(pdata);
//}
//
...
//	explored->destructData = &destructData;
//
...
//
//			Data_t *currentNodeData = constructData();
//			currentNodeData->frontier->data;
...
//		path->destructData = &destructData;
...
//}
//
//OV_DLLFNCEXPORT OV_RESULT graphSearch_bfs_EN_set(
//		OV_INSTPTR_graphSearch_bfs pobj, const OV_UINT value) {
//	pobj->v_EN = value;
//	OV_TIME pltc;
//
//	switch (value) {
...
//			graphSearch_bfs_typemethod(Ov_StaticPtrCast(fb_functionblock, pobj),
//				&pltc);
//			break;
//		case 3:
