...
//	gtpf_assozierer_typemethod(Ov_StaticPtrCast(fb_functionblock, gpinst),
// gpltc); 	TEST_ASSERT_EQUAL(gpinst->v_result, 4);
//}
//	//test2 bad top
...
//	gtpf_assozierer_typemethod(Ov_StaticPtrCast(fb_functionblock, gpinst),
// gpltc); 	TEST_ASSERT_EQUAL(gpinst->v_result,0); 	OV_UINT pathDirLen = 0;
...
//	ov_string_set_vecvalue_one(&gpinst->v_recipe, 3, "PE009 Heat", "PE025
// Turn", 		"PE033");
// gtpf_assozierer_typemethod(Ov_StaticPtrCast(fb_functionblock, gpinst),
// gpltc); TEST_ASSERT_EQUAL(gpinst->v_result, 0);
//
//	OV_UINT pathDirLen = 16;
//	OV_STRING pathDirValue[] = { "right", "right", "right", "right",
//			"heat", "left", "left", "left", "down", "right",
//"right", "right", "turn", 			"right", "right", "right" };
//	TEST_ASSERT_EQUAL(gpinst->v_pathDir.veclen, pathDirLen);
...
//			"PE009", "PE008", "PE005", "PE034", "PE034", "PE031",
//"PE030", "PE025", 			"PE025", "PE028", "PE027", "PE033" };
//	TEST_ASSERT_EQUAL(gpinst->v_pathNode.veclen, pathNodeLen);
...
// NULL, 			NULL, NULL, NULL, NULL, "180", NULL, NULL, NULL
// }; 	TEST_ASSERT_EQUAL(gpinst->v_parameter.veclen, paramLen);
//	TEST_ASSERT_EQUAL_STRING_ARRAY(paramValue, gpinst->v_parameter.value,
// paramLen);
//}
//
...
//	ov_string_set_vecvalue_one(&gpinst->v_recipe, 3, "PE009 Heat", "PE009
// Heat", 		"PE025 Turn", "PE025 Turn");
//	gtpf_assozierer_typemethod(Ov_StaticPtrCast(fb_functionblock, gpinst),
// gpltc);
//
...
TEST_GROUP_RUNNER(assozierer) {
  ...
  //  RUN_TEST_CASE(assozierer,
  //  ThisFunctionHasNotBeenTested_NeedsToBeImplemented);
}

static void RunAllTests(void) { RUN_TEST_GROUP(assozierer); }

OV_DLLFNCEXPORT void
gtpfTest_assoziererTest_typemethod(OV_INSTPTR_fb_functionblock pfb,
                                   OV_TIME*                    pltc) {
  /*
   *   local variables
   */
