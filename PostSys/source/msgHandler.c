...
OV_DLLFNCEXPORT void PostSys_msgHandler_startup(
...
OV_DLLFNCEXPORT void PostSys_msgHandler_shutdown(
	OV_INSTPTR_ov_object 	pobj
) {
    /*    
    *   local variables
...
OV_DLLFNCEXPORT OV_RESULT PostSys_msgHandler_HandleRequest(
    ...
    */
	...
	OV_ELEMENT						VarElem;
	OV_INSTPTR_PostSys_msgHandler	thisMsgHandler = Ov_StaticPtrCast(PostSys_msgHandler, this);
