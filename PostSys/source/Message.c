...
OV_DLLFNCEXPORT OV_ACCESS PostSys_Message_getaccess(
...
OV_DLLFNCEXPORT OV_STRING PostSys_Message_senderAddress_get(
    OV_INSTPTR_PostSys_Message          pobj
) {
    return pobj->v_senderAddress;
}

OV_DLLFNCEXPORT OV_RESULT PostSys_Message_senderAddress_set(
    OV_INSTPTR_PostSys_Message          pobj,
...
OV_DLLFNCEXPORT OV_STRING PostSys_Message_senderName_get(
    OV_INSTPTR_PostSys_Message          pobj
) {
    return pobj->v_senderName;
}

OV_DLLFNCEXPORT OV_RESULT PostSys_Message_senderName_set(
    OV_INSTPTR_PostSys_Message          pobj,
    const OV_STRING  value
) {
...
OV_DLLFNCEXPORT OV_STRING PostSys_Message_receiverAddress_get(
    OV_INSTPTR_PostSys_Message          pobj
) {
    return pobj->v_receiverAddress;
}

OV_DLLFNCEXPORT OV_RESULT PostSys_Message_receiverAddress_set(
    OV_INSTPTR_PostSys_Message          pobj,
    const OV_STRING  value
) {
...
OV_DLLFNCEXPORT OV_STRING PostSys_Message_receiverName_get(
    OV_INSTPTR_PostSys_Message          pobj
) {
    return pobj->v_receiverName;
}

OV_DLLFNCEXPORT OV_RESULT PostSys_Message_receiverName_set(
    OV_INSTPTR_PostSys_Message          pobj,
    const OV_STRING  value
) {
...
OV_DLLFNCEXPORT OV_STRING PostSys_Message_senderComponent_get(
    OV_INSTPTR_PostSys_Message          pobj
) {
    return pobj->v_senderComponent;
}

OV_DLLFNCEXPORT OV_RESULT PostSys_Message_senderComponent_set(
    OV_INSTPTR_PostSys_Message          pobj,
    const OV_STRING  value
) {
...
OV_DLLFNCEXPORT OV_STRING PostSys_Message_receiverComponent_get(
    OV_INSTPTR_PostSys_Message          pobj
) {
    return pobj->v_receiverComponent;
}

OV_DLLFNCEXPORT OV_RESULT PostSys_Message_receiverComponent_set(
    OV_INSTPTR_PostSys_Message          pobj,
    const OV_STRING  value
) {
...
OV_DLLFNCEXPORT OV_RESULT PostSys_Message_constructor(
	OV_INSTPTR_ov_object 	pobj
) {
	...
	PostSys_Message_senderName_set(this,servername);
...
OV_DLLFNCEXPORT void PostSys_Message_destructor(
	OV_INSTPTR_ov_object 	pobj
) {
    /*
    *   local variables
