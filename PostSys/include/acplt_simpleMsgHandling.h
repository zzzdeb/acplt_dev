...
OV_DLLFNCEXPORT OV_RESULT acplt_simpleMsg_xml_findElementBegin(
    char const* xml, const OV_STRING elemName, OV_STRING* pStart);
OV_DLLFNCEXPORT OV_RESULT acplt_simpleMsg_xml_getElementData(
    char const* xml, const OV_STRING elemName, OV_STRING* pData);
OV_DLLFNCEXPORT OV_RESULT acplt_simpleMsg_xml_getAttributeData(
    char const* xml, const OV_STRING elemName, const OV_STRING attributeName,
    OV_STRING* pData);
OV_DLLFNCEXPORT OV_RESULT
                acplt_simpleMsg_parseMessageHeader(char const* xml, ACPLT_MSGHEADER* header);
OV_DLLFNCEXPORT OV_RESULT acplt_simpleMsg_parseFlatBody(
    char const* xml, OV_STRING* svc, OV_STRING* op,
...
OV_DLLFNCEXPORT      OV_STRING
                     acplt_simpleMsg_generateMsgHeader(ACPLT_MSGHEADER const* header);
