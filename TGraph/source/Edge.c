...
OV_DLLFNCEXPORT OV_SINGLE* TGraph_Edge_physicalCost_get(
		OV_INSTPTR_TGraph_Edge pobj, OV_UINT *pveclen) {
	pobj->v_physicalCost.value[0] = fabs(
		pobj->v_Direction.value[0] + pobj->v_Direction.value[1])
			/ pobj->v_actVelocity.value[0];
	pobj->v_physicalCost.value[1] = fabs(pobj->v_Direction.value[2])
			/ pobj->v_actVelocity.value[1];
