...
OV_DLLFNCEXPORT OV_STRING CTree_helper_ovtypeToStr(OV_VAR_TYPE vartype) {
  switch(vartype) {
    case OV_VT_VOID: return "VOID";
    case OV_VT_BYTE: return "BYTE";
    case OV_VT_BOOL: return "BOOL";
    case OV_VT_INT: return "INT";
    case OV_VT_UINT: return "UINT";
    case OV_VT_SINGLE: return "SINGLE";
    case OV_VT_DOUBLE: return "DOUBLE";
    case OV_VT_STRING: return "STRING";
    case OV_VT_TIME: return "TIME";
    case OV_VT_TIME_SPAN: return "TIME_SPAN";
    case OV_VT_STATE: return "OV_STATE";
    case OV_VT_STRUCT: return "OV_STRUCT";

    case OV_VT_CTYPE: return "CTYPE";
    case OV_VT_POINTER: return "POINTER";

    case OV_VT_BYTE_VEC: return "BYTE_VEC";
    case OV_VT_BOOL_VEC: return "BOOL_VEC";
    case OV_VT_INT_VEC: return "INT_VEC";
    case OV_VT_UINT_VEC: return "UINT_VEC";
    case OV_VT_SINGLE_VEC: return "SINGLE_VEC";
    case OV_VT_DOUBLE_VEC: return "DOUBLE_VEC";
    case OV_VT_STRING_VEC: return "STRING_VEC";
    case OV_VT_TIME_VEC: return "TIME_VEC";
    case OV_VT_TIME_SPAN_VEC: return "TIME_SPAN_VEC";
    case OV_VT_TIME_SERIES: return "TIME_SERIES";
    case OV_VT_STATE_VEC: return "STATE_VEC";

    case OV_VT_STRUCT_VEC: return "STRUCT_VEC";

    case OV_VT_BOOL_PV: return "BOOL_PV";
    case OV_VT_INT_PV: return "INT_PV";
    case OV_VT_UINT_PV: return "UINT_PV*";
    case OV_VT_SINGLE_PV: return "SINGLE_PV";
    case OV_VT_DOUBLE_PV: return "DOUBLE_PV";
    case OV_VT_STRING_PV: return "STRING_PV";
    case OV_VT_TIME_PV: return "TIME_PV";
    case OV_VT_TIME_SPAN_PV: return "TIME_SPAN_PV";

    case OV_VT_BOOL_PV_VEC: return "BOOL_PV_VEC";
    case OV_VT_INT_PV_VEC: return "INT_PV_VEC";
    case OV_VT_UINT_PV_VEC: return "UINT_PV_VEC";
    case OV_VT_SINGLE_PV_VEC: return "SINGLE_PV_VEC";
    case OV_VT_DOUBLE_PV_VEC: return "DOUBLE_PV_VEC";
    case OV_VT_STRING_PV_VEC: return "STRING_PV_VEC";
    case OV_VT_TIME_PV_VEC: return "TIME_PV_VEC";
    case OV_VT_TIME_SPAN_PV_VEC: return "TIME_SPAN_PV_VEC";

    case OV_VT_ANY: return "ANY";
    default:
