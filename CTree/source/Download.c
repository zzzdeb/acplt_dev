 ...
 */
OV_STRING className_from_path(const OV_STRING const factory) {
	OV_UINT len = 0;
...
//factory
	...
	cJSON_AddStringToObject(jsobj, FACTORYNAME, className_from_path(factory));
